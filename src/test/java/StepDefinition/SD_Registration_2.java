...
public class SD_Registration_2 extends BaseClass {
	...
	public void user_fills_the_valid_digit_mobile_number_in_numerics(Integer int1) {
	    rp.setPhoneNumber("231-234-2345");
	}
	...
	@When("User enter FirstName {string}, LastName {string} , Address {string} , StreetName {string} , City {string} , State\"No Data\" , Zip {string} , BithDate {string} , PhoneNumber {string} , UserName {string} , Password {string} , Email {string}")
	public void user_enter_first_name_last_name_address_street_name_city_state_no_data_zip_bith_date_phone_number_user_name_password_email(String string, String string2, String string3, String string4, String string5, String string6, String string7, String string8, String string9, String string10, String string11) {
	    // Write code here that turns the phrase above into concrete actions
	...
	@When("User enter FirstName {string}, LastName {string} , Address {string} , StreetName {string} , City {string} , State\"Valid\" , Zip {string} , BithDate {string} , PhoneNumber {string} , UserName {string} , Password {string} , Email {string}")
	public void user_enter_first_name_last_name_address_street_name_city_state_valid_zip_bith_date_phone_number_user_name_password_email(String string, String string2, String string3, String string4, String string5, String string6, String string7, String string8, String string9, String string10, String string11) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@When("User enter FirstName {string}, LastName {string} , Address {string} , StreetName {string} , City {string} , State\"Invalid\" , Zip {string} , BithDate {string} , PhoneNumber {string} , UserName {string} , Password {string} , Email {string}")
	public void user_enter_first_name_last_name_address_street_name_city_state_invalid_zip_bith_date_phone_number_user_name_password_email(String string, String string2, String string3, String string4, String string5, String string6, String string7, String string8, String string9, String string10, String string11) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
